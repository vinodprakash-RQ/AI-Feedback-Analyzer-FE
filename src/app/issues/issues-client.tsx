...
const navItems = [{ label: 'Overview', href: '/', icon: LayoutDashboard }, { label: 'Issues', href: '/issues', icon: Inbox, count: String(mockIssues.length) }];
